...
$('.reload').click(function () {
    window.location = '/super_admin/dashboard_1d';
});

function hot_block_data() {
    $.ajax({
        method: 'GET',
        url: location.protocol + "//" + location.host + '/api/hot_block_1d',
        data: {
            date: date
        },
...
function changeDate() {
    ...
    $('#bet_slip').empty();
    $.ajax({
        url: 'https://admin.myvipmm.com/super_admin/dashboard_1d' + "?_=" + new Date().getTime(),
        dataType: "script",
        cache: false,
        async: true
...
$.ajax({
    method: 'POST',
    url: location.protocol + "//" + location.host + '/super_admin/grant_numbers_1d',
    data: {
        date: date,
        time: section
    },
...
$(document).on('click', '.custom_dashboard', function () {
    ...
    $.ajax({
        method: 'POST',
        url: location.protocol + "//" + location.host + '/super_admin/single_detail_1d',
        data: {
            date: date,
            time: section,
            number: number
...
$.ajax({
    method: 'POST',
    url: location.protocol + "//" + location.host + '/super_admin/time_statics_1d',
    data: {
        date: date,
        time: section
    },
...
$('.section').click(async function () {
   ...
   await  $.ajax({
    ...
    await $.ajax({
        method: 'POST',
        url: location.protocol + "//" + location.host + '/super_admin/clearance_1d',
        data: {
            date: date,
            section: section
        },
   ...
   await $.ajax({
        method: 'POST',
        url: location.protocol + "//" + location.host + '/super_admin/bet_slips_1d',
        data: {
            date: date,
            section: section
        },
...
$('.daily').click(async function () {
  ...
  await  $('#bet_slip').empty();
   ...
   await $.ajax({
        method: 'POST',
        url: location.protocol + "//" + location.host + '/super_admin/daily_grant_numbers_1d',
        data: {
            date: date,
        },
        success: function (data) {
    ...
    $.ajax({
        method: 'POST',
        url: location.protocol + "//" + location.host + '/super_admin/daily_statics_1d',
        data: {
            date: date
        },
        success: function (data) {
    ...
    $.ajax({
        method: 'POST',
        url: location.protocol + "//" + location.host + '/super_admin/daily_bet_slips_1d',
        data: {
            date: date,
        },
        success: function (data) {
...
$(document).on('click', '.custom_daily', function () {
    ...
    $.ajax({
        method: 'POST',
        url: location.protocol + "//" + location.host + '/super_admin/daily_detail_1d',
        data: {
            date: date,
            number: number
        },
        ...
        $.each(data, function (i, val) {
            $('#bet_slip').append(`
                <tr>
                    ...
                    <td>`+ val.total_bet + `</td>
                    <td>`+ val.date + `</td>
                    <td><a href="bet_slip_1d/`+ val.action + `" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye"></i></button></a></td>
                </tr>
            `);
        });
    }
