        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select class="form-control select2 year">
                    ...
                    <option value="{{ $item }}" @if (request()->year) @if ($item == request()->year)
                        selected @endif
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select class="form-control select2 month">
                    ...
                    <option value="{{ $key }}" @if (request()->month) @if ($key == request()->month)
                        selected @endif
...
<div class="tab-content" id="accountContent">
    <div class="tab-pane fade div_section active show" id="id-section" role="tabpanel" aria-labelledby="id-section-tab">
        ...
        <div class="row border border-5 border-dark callout justify-content-center mt-3 all_bet scrollable_3d scrollbarbackgroundblue_3d dashboard_3d_scroll">
            ...
            <div class="p-2">
                ...
                <button type="button" class="btn btn-block btn-lg custom_dashboard{{ $isBlocked ? ' bg-danger active disabled' : '' }} {{ $isHot && $betAmount >= $hot_amount ? 'bg-danger' : '' }} {{ $betAmount < $overAll->over_all_amount_3d ? '' : 'bg-danger active' }} {{ $betAmount == 0 ? 'bg-secondary' : '' }}" data-toggle="modal" data-target="{{ $isBlocked ? '' : '#example' . $t->bet_number }}">
                    ...
                    <table id="bet_slip_dash_datatable" class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->date }}</td>
                                <td>
                                    <a href="{{ url('/super_admin/bet_slip_3d/' . $item->id) }}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye"></i></button></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
