    ...
    <script>
        $(function() {
            ...
            $('.reload').click(function() {
                window.location = `/game/player_detail?user_code=${url_name}`;
            });
                ...
                <table class="table table-xs bg-secondary">
                    ...
                    <tbody>
                       ${Object.keys(data).length >0 ? (
                        ...
                        `               <tr>
                                                                                                        <td>
                                                                                                            <a href="/game/transaction_reports?date=${data[provider]?.date}&provider=${provider}&username={{ $user_code }}">${provider}</a>
                                                                                                        </td>  
