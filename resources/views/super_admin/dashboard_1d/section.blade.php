...
@section('title', 'Super Admin 1D Dashboard')

@section('dashboard-1d-active', 'active')

@section('content')
    <h3 class="text-center">Please the 1D Time Section</h3>
    ...
    <div class='contaner'>
        <div class=" " style="height:300px;">
            <div class='d-flex row justify-content-center align-item-center mt-5 text-white' >
                   ...
                   <a href="{{route('dashboard.section1d',$n->time_section)}}" class='col-3 m-3'>
