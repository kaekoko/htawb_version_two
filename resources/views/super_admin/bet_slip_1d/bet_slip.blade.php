...
@section('title', '1D Bet Slips')

@section('bet-slip-1d-active', 'active')
                            ...
                            <tbody>
                                @foreach ($bet_slips as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/super_admin/bet_slip_1d/'.$item->id) }}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
@section('scripts')
    <script>
        ...
        $('.reload').click(function(){
            window.location = '/super_admin/bet_slip_1d';
        });
