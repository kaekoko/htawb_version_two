...
@section('title', "Crypto 2D Bet Slips # $bet_slip_detail->id Detail")
    ...
    <div class="card card-dark card-outline bet_slip">
        <div class="card-body">
            <table class="table table-bordered table-sm table-responsive-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{ $bet_slip_detail->bettings_c2d[0]->category->name ?? '-' }}</td>
            ...
            <table class="table table-bordered table-sm table-responsive-sm">
                ...
                <tbody>
                    @foreach($bet_slip_detail->bettings_c2d as $bet)
