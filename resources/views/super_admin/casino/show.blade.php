...
@section('content')
<a href="{{url('/game/user')}}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
<a href="{{ url('game/user/'.$user->id.'/edit') }}" title="Edit"><button class="btn btn-dark btn-sm"><i class="fa fa-solid fa-pen"></i> Edit</button></a>
<div class="row mt-3">
