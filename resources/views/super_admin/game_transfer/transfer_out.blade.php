...
@section('title', 'Transfer Game Wallet To Main Wallet')

@section('transfer-out-active', 'active')
                ...
                <div class="col-12">
                    <div class="table-responsive">
                        <table id="data_table_super_admin" class="table table-striped table-sm">
                            ...
                            <tbody>
                                @foreach ($transfer_outs as $key => $item)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $item->user->name }}</td>
                                        <td>{{ $item->user->phone }}</td>
                                        <td>{{ $item->user->user_code }}</td>
                                        <td>{{ number_format($item->main_balance) }}</td>
