...
<h5>Crypto 2D Betslip History user</h5>
<form method="get" action="{{url('super_admin/user/crypto2d_betslips_only/'. $user_id)}}">
                                ...
                                <td colspan="8">
                                    <div class="collapse" id="collpase_{{$slip->id}}">
                                        <table class="table bg-white">
                                            ...
                                            <tbody>
                                                @foreach ($slip->bettings_c2d as $s )
...
<script>
    function openWindowAtTopLeft(warger) {
        ...
        window.open(`https://prodmd.9977997.com/Report/BetDetail?agentCode=E333&WagerID=${warger}`, '_blank',
            windowFeatures);
    }
</script>
@endsection
