...
@section('title', 'Crypto 1D Bet Slips')

@section('bet-slip-crypto-1d-active', 'active')
                            ...
                            <tbody>
                                @foreach ($bet_slips as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/super_admin/bet_slip_c1d/'.$item->id) }}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
