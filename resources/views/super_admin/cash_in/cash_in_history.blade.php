...
<div class="d-flex flex-wrap">
    ...
    <div class="p-2">
        <div class="btn btn-sm btn-success">
            Total Amount <span class="badge badge-light">{{ number_format($cash_ins->sum('amount')) }}</span>
        </div>
    </div>
</div><br>
                            ...
                            <tbody>
                                @foreach ($cash_ins as $i=>$item)
                                    <tr>
                                        ...
                                        <td><span class="text-success font-weight-bold">{{ number_format($item->amount ?? '0.00') }} MMK</span></td>
        ...
        $(function() {
            ...
            $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
                ...
                history.pushState(null, '', '?start_date=' + start + '&end_date=' + end + '&status=' +
                    status + '&promo=' + promo + '&payment=' + payment)
