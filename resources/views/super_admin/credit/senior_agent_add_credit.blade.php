...
@section('content')
    ...
    <div class="card card-dark card-outline">
        <div class="card-body">
            <div class="row mt-3">
                <div class="col-12">
                    <form method="POST" enctype="multipart/form-data" action="{{ url('/super_admin/senior_agent_update_credit/'.$agent->id) }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <label>Role</label>
                            <input type="text" class="form-control form-control-sm" value="Senior Agent" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-dark">Add Credit</button>
                    </form>
                </div>
            </div>
        </div>
