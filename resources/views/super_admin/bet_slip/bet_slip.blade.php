                            ...
                            <tbody>
                                @foreach ($bet_slips as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/super_admin/bet_slip/'.$item->id) }}" title="View"><button class="btn btn-info btn-sm"><i class="fa fa-eye"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
...
@section('scripts')
    <script>
        ...
        $('.reload').click(function(){
            window.location = '/super_admin/bet_slip';
        });
