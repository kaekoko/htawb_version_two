...
@section('social-link-active', 'active')
...
@section('content')
    <div class="card card-dark card-outline">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <form method="POST" enctype="multipart/form-data" action="{{ url('super_admin/social_link_update') }}">
                        @csrf
                ...
                <div class="col-md-6 mt-3">
                    <form method="POST" enctype="multipart/form-data" action="{{ url('super_admin/social_link_update') }}">
                        @csrf
                        <div class="form-group">
                            <label class="text-md">Instagram</label>
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ url('super_admin/social_link_update') }}">
                        ...
                        <div class="form-group">
                            ...
                            @if($qr->value)
                                ...
                                <a href="{{ url('super_admin/social_link/qr_image_delete') }}" onclick="return confirm('Confirm delete?')" style="color: red;"><i class="fas fa-trash"></i></a>
                            @else
