...
@section('content')
    <div class="d-flex flex-wrap">
        ...
        <div class="p-2">
            <a href="{{ url('/super_admin/lucky_number_1d/create') }}" class="btn btn-dark btn-sm" title="Add Lucky Number">
                    ...
                    <div class="table-responsive">
                        <table id="data_table" class="table table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <td>
                                    @if ($item->approve == 0)
                                    <form action="{{ url('super_admin/lucky_number/approve_1d/'.$item->id) }}" method="POST">
                                     @csrf
...
@section('scripts')
    <script>
        ...
        $('.reload').click(function(){
            window.location = '/super_admin/lucky_number_1d';
        });
