...
@section('title', 'Crypto 2D Lucky Number')
...
@section('content')
    <div class="d-flex flex-wrap">
        ...
        <div class="p-2">
            <a href="{{ url('/super_admin/lucky_number_c2d/create') }}" class="btn btn-dark btn-sm" title="Add Lucky Number">
                            ...
                            <tbody>
                                @foreach ($lucky_numbers as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->approve == 0)
                                               <form action="{{url('super_admin/app_c2d')}}" method="POST">
                                                @csrf
...
@section('scripts')
    <script>
        ...
        $('.reload').click(function() {
            window.location = '/super_admin/lucky_number_c2d';
        });
    </script>
@endsection
